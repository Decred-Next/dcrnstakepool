...
var (
	...
	// build process with:
	// '-ldflags "-X github.com/Decred-Next/dcrnstakepool/internal/version.PreRelease=foo"'
	...
	// build process with:
	// '-ldflags "-X github.com/Decred-Next/dcrnstakepool/internal/version.BuildMetadata=foo"'
